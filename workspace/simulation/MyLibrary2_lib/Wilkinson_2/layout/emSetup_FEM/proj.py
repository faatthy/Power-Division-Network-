...
def set_frequency_plan_and_common_options():
	...
	if empro.activeProject.parameters().contains('minFreq'):
		empro.activeProject.parameters().setFormula('minFreq','1 GHz')
	if empro.activeProject.parameters().contains('maxFreq'):
		empro.activeProject.parameters().setFormula('maxFreq','6 GHz')
	empro.activeProject.createSimulationData().saveFieldsFor="NoFrequencies"
...
class projImporter():
	...
	def create_materials(self,materialForEachLayer=False):
		...
		extraMaterialProperties=(132,3.5e-05,False,True) # (priority,thickness,modelTypeForMetals,convertedToResistance)
		material=ADSmaterialMap.get((ADSmaterialName,extraMaterialProperties),None)
		if material == None:
			EMProMaterialName = self._getEMProMaterialName(ADSmaterialName,ADSmaterialMap,extraMaterialProperties,ADSmaterialsNo1to1)
		...
		extraMaterialProperties=(120,3.5e-05,None,True) # (priority,thickness,modelTypeForMetals,convertedToResistance)
		material=ADSmaterialMap.get((ADSmaterialName,extraMaterialProperties),None)
		if material == None:
			EMProMaterialName = self._getEMProMaterialName(ADSmaterialName,ADSmaterialMap,extraMaterialProperties,ADSmaterialsNo1to1)
			material=self.session.create_material(name=EMProMaterialName, color=(210,210,210,255), thickness="3.5e-05 m", resistance=1.72413793103448e-08/3.5e-05, permeability=1)
			try:
				material.details.electricProperties.parameters.thickness = "3.5e-05 m"
			except AttributeError:
				pass
			try:
				material.priority=120
				material.autoPriority=False
			except AttributeError:
				pass
			ADSmaterialMap[(ADSmaterialName,extraMaterialProperties)]=material
		...
		if material == None:
			EMProMaterialName = self._getEMProMaterialName(ADSmaterialName,ADSmaterialMap,extraMaterialProperties,ADSmaterialsNo1to1)
			material=self.session.create_material(name=EMProMaterialName, color=(202,225,255,128), permittivity=4.5, losstangent=0.01, permeability=1, use_djordjevic=True, lowfreq=1000, evalfreq=10000000000, highfreq=1000000000000)
			try:
	...
	def initNetlists(self):
		netlistNames = ['net_0','net_1_N__51_P1_P2_P4_P5']
	...
	def create_geometry(self,topAssembly):
		...
		assembly=empro.geometry.Assembly()
		part=empro.geometry.Model()
		simBox = empro.geometry.Box( _createIfToggleExtensionToBoundingBoxExpression("xUpperBoundingBox-xLowerBoundingBox", "abs((-0.0374811-xLowerExtension)-(-0.0076028+xUpperExtension))"), _createIfToggleExtensionToBoundingBoxExpression("zUpperBoundingBox-zLowerBoundingBox", "((((stack_substrate2_layer_3_Z) + (zUpperExtension)) - (stack_substrate2_layer_1_Z)))"), _createIfToggleExtensionToBoundingBoxExpression("yUpperBoundingBox-yLowerBoundingBox" , " abs((-0.0066239-yLowerExtension)-(0.0066001+yUpperExtension))"))
		part.recipe.append(simBox)
		part.coordinateSystem.anchorPoint = empro.geometry.CoordinateSystemPositionExpression(V(_createIfToggleExtensionToBoundingBoxExpression("(xUpperBoundingBox+xLowerBoundingBox)/2", "(-0.0076028+xUpperExtension+-0.0374811-xLowerExtension)/2"), _createIfToggleExtensionToBoundingBoxExpression("(yUpperBoundingBox+yLowerBoundingBox)/2", "(0.0066001+yUpperExtension+-0.0066239-yLowerExtension)/2"), _createIfToggleExtensionToBoundingBoxExpression("zLowerBoundingBox","((stack_substrate2_layer_1_Z) - (0))")))
		...
		self.session.adjust_view()
		assembly=empro.geometry.Assembly()
		pointString='-0.0076028+xUpperExtension#-0.0066239-yLowerExtension;-0.0076028+xUpperExtension#0.0066001+yUpperExtension;-0.0374811-xLowerExtension#0.0066001+yUpperExtension;-0.0374811-xLowerExtension#-0.0066239-yLowerExtension'
		sketch = self._create_sketch(pointString)
		sketch.constraintManager().append(empro.geometry.FixedPositionConstraint("vertex0",V(_createIfToggleExtensionToBoundingBoxExpression("xLowerBoundingBox","-0.0374811-xLowerExtension"),_createIfToggleExtensionToBoundingBoxExpression("yLowerBoundingBox","-0.0066239-yLowerExtension"),0)))
		sketch.constraintManager().append(empro.geometry.FixedPositionConstraint("vertex1",V(_createIfToggleExtensionToBoundingBoxExpression("xUpperBoundingBox","-0.0076028+xUpperExtension"),_createIfToggleExtensionToBoundingBoxExpression("yLowerBoundingBox","-0.0066239-yLowerExtension"),0)))
		sketch.constraintManager().append(empro.geometry.FixedPositionConstraint("vertex2",V(_createIfToggleExtensionToBoundingBoxExpression("xUpperBoundingBox","-0.0076028+xUpperExtension"),_createIfToggleExtensionToBoundingBoxExpression("yUpperBoundingBox","0.0066001+yUpperExtension"),0)))
		sketch.constraintManager().append(empro.geometry.FixedPositionConstraint("vertex3",V(_createIfToggleExtensionToBoundingBoxExpression("xLowerBoundingBox","-0.0374811-xLowerExtension"),_createIfToggleExtensionToBoundingBoxExpression("yUpperBoundingBox","0.0066001+yUpperExtension"),0)))
		part=empro.geometry.Model()
		part.recipe.append(empro.geometry.Extrude(sketch,"(stack_substrate2_layer_3_Z) - (stack_substrate2_layer_1_Z)",V(0,0,1)))
		part.coordinateSystem.anchorPoint = empro.geometry.CoordinateSystemPositionExpression(V(0,0,"(stack_substrate2_layer_1_Z) - (0)"))
		...
		topAssembly.append(assembly)
		assembly=empro.geometry.Assembly()
		pointStrings=['-0.031328#0.0010864;-0.0294008#0.0010813;-0.0293998#0.0014455;-0.0293999#0.0003734;-0.0281399#0.0003734;-0.0281399#0.0007234;-0.0271889#0.0007234;-0.0271889#0.0007332;-0.0257281#0.002194;-0.0257281#0.0043262;-0.0076028#0.0043262;-0.0076028#0.0057968;-0.0257281#0.0057968;-0.0271987#0.0043262;-0.0271987#0.002194;-0.0287699#0.002194;-0.0287699#0.001836;-0.0313279#0.0018411;-0.0313279#0.0058455;-0.0320825#0.0066001;-0.0363472#0.0066001;-0.0371018#0.0058455;-0.0371018#0.0007234;-0.0374811#0.0007234;-0.0374811#-0.0007472;-0.0371018#-0.0007472;-0.0371018#-0.0058693;-0.0363472#-0.0066239;-0.0320825#-0.0066239;-0.0313279#-0.0058693;-0.0313279#-0.0018649;-0.0287699#-0.0018598;-0.0287699#-0.0022178;-0.0271987#-0.0022178;-0.0271987#-0.00435;-0.0257281#-0.0058206;-0.0246735#-0.0058206;-0.0246735#-0.00435;-0.0257281#-0.00435;-0.0257281#-0.0022178;-0.0271889#-0.000757;-0.0271889#-0.0007472;-0.0281399#-0.0007472;-0.0281399#-0.0003972;-0.0293999#-0.0003972;-0.0293998#-0.0014693;-0.0294008#-0.0011051;-0.031328#-0.0011102;-0.0320825#-0.0018669;-0.0320825#-0.0058693;-0.0363472#-0.0058693;-0.0363472#0.0058455;-0.0320825#0.0058455;-0.0320825#0.0018431']
		...
		part.meshParameters=empro.mesh.ModelMeshParameters()
		part.meshParameters.priority=132
		...
		topAssembly.append(assembly)
		assembly=empro.geometry.Assembly()
		pointStrings=['-0.0044778#-0.0097489;-0.0044778#0.0097251;-0.0406061#0.0097251;-0.0406061#-0.0097489']
		sketch = None
		for pointString in pointStrings:
			sketch = self._create_sketch(pointString, sketch)
		sketch.constraintManager().append(empro.geometry.FixedPositionConstraint("vertex0",V(_createIfToggleExtensionToBoundingBoxExpression("xLowerBoundingBox","-0.0374811-xLowerExtension"),_createIfToggleExtensionToBoundingBoxExpression("yLowerBoundingBox","-0.0066239-yLowerExtension"),0)))
		...
		try:
			...
			if mtrl.details.materialType() == "Physical": 
				...
				if eProp.propertyType() == "PEC" or eProp.parameters.parametersType() == "PEC":
					...
					if (empro.core.Expression("((stack_substrate2_layer_1_Z) - (0))").toDouble() <= bbox_3dcs.lower.z + SPAresabs ) :
						part.meshParameters.includeInMesh=False
						empro.activeProject.parameters().setFormula( "zLowerExtension", "0 mm")
		except AttributeError:
			part.meshParameters.includeInMesh=False
		part.meshParameters.priority=120
	...
	def create_ports( self, topAssembly, includeInvalidPorts=True, symbPinData=None):
		...
		if topAssembly != None:
			...
			bbox_geom = empro.activeProject.geometry().boundingBox()
		xLowerBoundary = bbox_geom.lower.x.toDouble()
		xUpperBoundary = bbox_geom.upper.x.toDouble()
		yLowerBoundary = bbox_geom.lower.y.toDouble()
		yUpperBoundary = bbox_geom.upper.y.toDouble()
		zLowerBoundary = bbox_geom.lower.z.toDouble()
		zUpperBoundary = bbox_geom.upper.z.toDouble()
		...
		if getSessionVersion(self.session) >= 7:
			...
			for name,waveform in self.waveforms.items():
				...
				self.waveforms[name] = empro.activeProject.waveforms().at(empro.activeProject.waveforms().size()-1)
		...
		if getSessionVersion(self.session) >= 7:
			...
			for name,compDef in self.circuitComponentDefinitions.items():
				...
				self.circuitComponentDefinitions[name] = empro.activeProject.circuitComponentDefinitions().at(empro.activeProject.circuitComponentDefinitions().size()-1)
		head=V("(-0.0374811) - (0)","(-1.19e-05) - (0)","(((mask_cond_Zmax) + (mask_cond_Zmin)) / (2)) - (0)")
		tail=V("(-0.0374811) - (0)","(-1.19e-05) - (0)","(stack_substrate2_layer_1_Z) - (0)")
		extent=empro.components.SheetExtent()
		extent.endPoint1Position=V("(-0.0374811) - (0)","(-0.0007472) - (0)","(stack_substrate2_layer_1_Z) - (0)")
		extent.endPoint2Position=V("(-0.0374811) - (0)","(0.0007234) - (0)","(((mask_cond_Zmax) + (mask_cond_Zmin)) / (2)) - (0)")
		...
		for headOrTail in headsAndTails:
			if abs(headOrTail.x.toDouble() - xLowerBoundary) < SPAresabs: internalPortOnXLowerBoundary = True
			if abs(headOrTail.x.toDouble() - xUpperBoundary) < SPAresabs: internalPortOnXUpperBoundary = True
			if abs(headOrTail.y.toDouble() - yLowerBoundary) < SPAresabs: internalPortOnYLowerBoundary = True
			if abs(headOrTail.y.toDouble() - yUpperBoundary) < SPAresabs: internalPortOnYUpperBoundary = True
			if abs(headOrTail.z.toDouble() - zLowerBoundary) < SPAresabs: internalPortOnZLowerBoundary = True
			if abs(headOrTail.z.toDouble() - zUpperBoundary) < SPAresabs: internalPortOnZUpperBoundary = True
		head=V("(-0.0076028) - (0)","(0.0050615) - (0)","(((mask_cond_Zmax) + (mask_cond_Zmin)) / (2)) - (0)")
		tail=V("(-0.0076028) - (0)","(0.0050615) - (0)","(stack_substrate2_layer_1_Z) - (0)")
		extent=empro.components.SheetExtent()
		extent.endPoint1Position=V("(-0.0076028) - (0)","(0.0043262) - (0)","(stack_substrate2_layer_1_Z) - (0)")
		extent.endPoint2Position=V("(-0.0076028) - (0)","(0.0057968) - (0)","(((mask_cond_Zmax) + (mask_cond_Zmin)) / (2)) - (0)")
		...
		for headOrTail in headsAndTails:
			...
			if abs(headOrTail.z.toDouble() - zLowerBoundary) < SPAresabs: internalPortOnZLowerBoundary = True
			if abs(headOrTail.z.toDouble() - zUpperBoundary) < SPAresabs: internalPortOnZUpperBoundary = True
		head=V("(-0.0246735) - (0)","(-0.0050853) - (0)","(((mask_cond_Zmax) + (mask_cond_Zmin)) / (2)) - (0)")
		tail=V("(-0.0246735) - (0)","(-0.0050853) - (0)","(stack_substrate2_layer_1_Z) - (0)")
		extent=empro.components.SheetExtent()
		extent.endPoint1Position=V("(-0.0246735) - (0)","(-0.0058206) - (0)","(stack_substrate2_layer_1_Z) - (0)")
		extent.endPoint2Position=V("(-0.0246735) - (0)","(-0.00435) - (0)","(((mask_cond_Zmax) + (mask_cond_Zmin)) / (2)) - (0)")
		...
		for headOrTail in headsAndTails:
			...
			if abs(headOrTail.z.toDouble() - zLowerBoundary) < SPAresabs: internalPortOnZLowerBoundary = True
			if abs(headOrTail.z.toDouble() - zUpperBoundary) < SPAresabs: internalPortOnZUpperBoundary = True
		head=V("(-0.0287699) - (0)","(0.0007234) - (0)","(((mask_cond_Zmax) + (mask_cond_Zmin)) / (2)) - (0)")
		tail=V("(-0.0287699) - (0)","(-0.0007472) - (0)","(((mask_cond_Zmax) + (mask_cond_Zmin)) / (2)) - (0)")
		extent=None
		port = self._create_internal_port("P4","100 ohm Voltage Source",head,tail,extent)
		portShortcutGroups.append((1,port))
		ports.append(port)
	...
	def create_parameters(self):
		self._create_parameter("stack_substrate2_layer_1_Z", "0 mm", "Z of topology level (level 1 of stack substrate2)",True,fixGridAxis='Z')
		self._create_parameter("stack_substrate2_layer_3_Z", "0.8 mm", "Z of topology level (level 3 of stack substrate2)",True,fixGridAxis='Z')
